        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-none d-md-flex align-items-center gap-2">
                    <a href="{{ route('login') }}" class="btn-nav-login"><i class="bi bi-person"></i> LOGIN</a>
            ...
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <div class="filter-tabs">
                        <button class="filter-tab active" data-filter="all"><i class="bi bi-grid-3x3-gap"></i>
                            Semua</button>
                ...
                <div class="search-wrap">
                    ...
                    <input type="text" class="search-input-category" id="searchInput"
    ...
    <div class="vehicle-grid">
        <div class="container">
            ...
            <div class="section-divider" id="mobilDivider">
                ...
                <div class="section-divider-label"><i class="bi bi-car-front-fill"></i> MOBIL <span
                        class="section-divider-count" id="mobilCount">10</span></div>
                <div class="section-divider-line"></div>
            </div>
            ...
            <div class="row g-4" id="mobilGrid">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="City Car"
                    data-name="toyota yaris" data-price="350000" style="transition-delay:0s">
                        ...
                        <div class="car-card">
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 350.000</span><span
                ...
                <!-- Fortuner -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="SUV"
                    data-name="fortuner vrz" data-price="750000" style="transition-delay:0.06s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc1" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 75 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 75 Z"
                                        fill="url(#mc1)" stroke="#282828" stroke-width="1" />
                                    <path d="M68 75 L90 44 Q98 38 112 38 L170 38 Q184 38 192 44 L212 75 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="20" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="208" cy="101" r="20" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                </svg>
                            </div>
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 750.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- BMW -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="Sedan"
                    data-name="bmw 320i" data-price="1200000" style="transition-delay:0.12s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc2" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 80 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 80 Z"
                                        fill="url(#mc2)" stroke="#282828" stroke-width="1" />
                                    <path d="M72 80 L92 55 Q100 48 114 48 L168 48 Q182 48 188 55 L208 80 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="18" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="208" cy="101" r="18" fill="#0e0e0e" stroke="#333"
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 1.200.000</span><span
                                            class="price-label">per hari</span></div>
                ...
                <!-- Innova Zenix -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="MPV"
                    data-name="innova zenix" data-price="600000" style="transition-delay:0.18s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc3" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 76 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 76 Z"
                                        fill="url(#mc3)" stroke="#282828" stroke-width="1" />
                                    <path d="M66 76 L86 46 Q94 40 108 40 L174 40 Q188 40 194 46 L214 76 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="20" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="208" cy="101" r="20" fill="#0e0e0e" stroke="#333"
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 600.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- Brio -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="City Car"
                    data-name="honda brio" data-price="250000" style="transition-delay:0.24s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc4" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 78 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 78 Z"
                                        fill="url(#mc4)" stroke="#282828" stroke-width="1" />
                                    <path d="M70 78 L88 50 Q95 42 107 42 L173 42 Q185 42 192 50 L210 78 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="18" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 250.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- Alphard -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="Luxury"
                    data-name="alphard hev" data-price="1800000" style="transition-delay:0.30s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc5" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M25 74 L25 94 Q25 101 32 101 L248 101 Q255 101 255 94 L255 74 Z"
                                        fill="url(#mc5)" stroke="#282828" stroke-width="1" />
                                    <path d="M65 74 L82 48 Q90 42 104 42 L176 42 Q190 42 198 48 L215 74 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="21" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="208" cy="101" r="21" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                </svg>
                            </div>
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 1.800.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- CRV -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="SUV"
                    data-name="honda cr-v turbo" data-price="680000" style="transition-delay:0.36s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc6" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 75 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 75 Z"
                                        fill="url(#mc6)" stroke="#282828" stroke-width="1" />
                                    <path d="M68 75 L90 44 Q98 38 112 38 L170 38 Q184 38 192 44 L212 75 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="20" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 680.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- Xpander -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="MPV"
                    data-name="xpander cross" data-price="520000" style="transition-delay:0.42s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc7" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 76 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 76 Z"
                                        fill="url(#mc7)" stroke="#282828" stroke-width="1" />
                                    <path d="M66 76 L86 46 Q94 40 108 40 L174 40 Q188 40 194 46 L214 76 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="20" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 520.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent opacity-50">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- Agya -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="City Car"
                    data-name="agya trd" data-price="220000" style="transition-delay:0.48s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                <span class="car-badge">HEMAT</span>
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc8" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 80 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 80 Z"
                                        fill="url(#mc8)" stroke="#282828" stroke-width="1" />
                                    <path d="M74 80 L90 55 Q97 48 110 48 L170 48 Q183 48 190 55 L206 80 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="18" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="208" cy="101" r="18" fill="#0e0e0e" stroke="#333"
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 220.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- Mercedes -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="mobil" data-cat="Luxury"
                    data-name="mercedes e300" data-price="2200000" style="transition-delay:0.54s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:240px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mc9" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#282828" />
                                            <stop offset="100%" style="stop-color:#141414" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="110" rx="110" ry="7"
                                        fill="rgba(0,0,0,0.45)" />
                                    <path d="M28 82 L28 94 Q28 101 35 101 L245 101 Q252 101 252 94 L252 82 Z"
                                        fill="url(#mc9)" stroke="#282828" stroke-width="1" />
                                    <path d="M72 82 L95 58 Q103 50 118 50 L162 50 Q177 50 185 58 L208 82 Z"
                                        fill="#1c1c1c" stroke="#222" stroke-width="1" />
                                    <circle cx="72" cy="101" r="18" fill="#0e0e0e" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="208" cy="101" r="18" fill="#0e0e0e" stroke="#333"
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 2.200.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
            ...
            <div class="row g-4" id="motorGrid">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="motor" data-cat="Matic"
                    data-name="honda vario 160" data-price="120000" style="transition-delay:0s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card motor-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <defs>
                                        <linearGradient id="mg0" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                    ...
                                    <line x1="80" y1="81" x2="80" y2="115"
                                        stroke="#282828" stroke-width="1.5" />
                                    <line x1="63" y1="98" x2="97" y2="98"
                                        stroke="#282828" stroke-width="1.5" />
                                    ...
                                    <circle cx="210" cy="98" r="5" fill="#1a1a1a"
                                        stroke="rgba(0,212,255,0.4)" stroke-width="1.2" />
                                    <path d="M80 96 L105 60 L165 55 L200 72 L210 80" fill="none" stroke="#2a2a2a"
                                        stroke-width="3" stroke-linecap="round" />
                                    <path d="M105 60 L165 55 L195 68 L175 80 L120 82 Z" fill="url(#mg0)"
                                        stroke="#333" stroke-width="1" />
                                    <ellipse cx="212" cy="70" rx="10" ry="7"
                                        fill="rgba(0,212,255,0.8)" opacity="0.7" />
                                    <rect x="76" y="68" width="10" height="5" rx="2"
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-specs">
                                    ...
                                    <div class="spec-item"><i class="bi bi-gear-fill" style="color:#00d4ff"></i>
                                        Matic</div>
                                    <div class="spec-item"><i class="bi bi-droplet-fill" style="color:#00d4ff"></i>
                                        Bensin</div>
                                </div>
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 120.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- R15 -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="motor" data-cat="Sport"
                    data-name="yamaha r15" data-price="180000" style="transition-delay:0.06s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card motor-card">
                            <div class="car-img-wrap">
                                <span class="car-badge">SPORTY</span>
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <circle cx="210" cy="98" r="5" fill="#1a1a1a"
                                        stroke="rgba(0,212,255,0.4)" stroke-width="1.2" />
                                    <path d="M80 96 L105 58 L168 52 L202 68 L210 80" fill="none" stroke="#2a2a2a"
                                        stroke-width="3" stroke-linecap="round" />
                                    <path d="M105 58 L168 52 L198 65 L178 78 L122 80 Z" fill="url(#mg1)"
                                        stroke="#333" stroke-width="1" />
                                    <ellipse cx="212" cy="68" rx="10" ry="7"
                                        fill="rgba(0,212,255,0.8)" opacity="0.7" />
                                    <rect x="76" y="66" width="10" height="5" rx="2"
                                        fill="rgba(255,50,50,0.9)" />
                                </svg>
                            </div>
                            <div class="car-body">
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 180.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- Nmax -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="motor" data-cat="Matic"
                    data-name="yamaha nmax" data-price="140000" style="transition-delay:0.12s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card motor-card">
                            <div class="car-img-wrap">
                                <span class="car-badge">POPULER</span>
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:220px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mg2" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
                                            <stop offset="0%" style="stop-color:#252525" />
                                            <stop offset="100%" style="stop-color:#151515" />
                                        </linearGradient>
                                    ...
                                    <path d="M80 96 L105 60 L165 55 L200 72 L210 80" fill="none" stroke="#2a2a2a"
                                        stroke-width="3" stroke-linecap="round" />
                                    <path d="M105 60 L165 55 L195 68 L175 80 L120 82 Z" fill="url(#mg2)"
                                        stroke="#333" stroke-width="1" />
                                    <ellipse cx="212" cy="70" rx="10" ry="7"
                                        fill="rgba(0,212,255,0.8)" opacity="0.7" />
                                    <rect x="76" y="68" width="10" height="5" rx="2"
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-specs">
                                    <div class="spec-item"><i class="bi bi-speedometer2"
                                            style="color:#00d4ff"></i> 155cc</div>
                                    <div class="spec-item"><i class="bi bi-gear-fill" style="color:#00d4ff"></i>
                                        Matic</div>
                                    <div class="spec-item"><i class="bi bi-droplet-fill"
                                            style="color:#00d4ff"></i> Bensin</div>
                                </div>
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 140.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent opacity-50">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- CRF -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="motor" data-cat="Trail"
                    data-name="honda crf150l" data-price="160000" style="transition-delay:0.18s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card motor-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:220px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mg3" x1="0%" y1="0%"
                                            x2="100%" y2="100%">
                                            <stop offset="0%" style="stop-color:#252525" />
                                            <stop offset="100%" style="stop-color:#151515" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="112" rx="105" ry="6"
                                        fill="rgba(0,0,0,0.4)" />
                                    <circle cx="75" cy="95" r="28" fill="#111" stroke="#2a2a2a"
                                        stroke-width="2" />
                                    <circle cx="75" cy="95" r="19" fill="#0a0a0a" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="75" cy="95" r="6" fill="#1a1a1a"
                                        stroke="rgba(0,212,255,0.4)" stroke-width="1.2" />
                                    <circle cx="215" cy="97" r="26" fill="#111" stroke="#2a2a2a"
                                        stroke-width="2" />
                                    <circle cx="215" cy="97" r="17" fill="#0a0a0a" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="215" cy="97" r="5" fill="#1a1a1a"
                                        stroke="rgba(0,212,255,0.4)" stroke-width="1.2" />
                                    <path d="M75 93 L100 55 L165 50 L200 68 L215 82" fill="none" stroke="#2a2a2a"
                                        stroke-width="3" stroke-linecap="round" />
                                    <path d="M100 55 L165 50 L195 63 L175 76 L118 78 Z" fill="url(#mg3)"
                                        stroke="#333" stroke-width="1" />
                                    <ellipse cx="217" cy="66" rx="10" ry="7"
                                        fill="rgba(0,212,255,0.8)" opacity="0.7" />
                                </svg>
                            </div>
                            <div class="car-body">
                                ...
                                <div class="car-specs">
                                    <div class="spec-item"><i class="bi bi-speedometer2"
                                            style="color:#00d4ff"></i> 150cc</div>
                                    <div class="spec-item"><i class="bi bi-gear-fill" style="color:#00d4ff"></i>
                                        Manual</div>
                                    <div class="spec-item"><i class="bi bi-droplet-fill"
                                            style="color:#00d4ff"></i> Bensin</div>
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 160.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                        ...
                        <div class="car-card motor-card">
                            <div class="car-img-wrap">
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <circle cx="210" cy="98" r="5" fill="#1a1a1a"
                                        stroke="rgba(0,212,255,0.4)" stroke-width="1.2" />
                                    <path d="M80 96 L108 58 L170 53 L204 70 L210 80" fill="none" stroke="#2a2a2a"
                                        stroke-width="3" stroke-linecap="round" />
                            ...
                            <div class="car-body">
                                ...
                                <div class="car-specs">
                                    <div class="spec-item"><i class="bi bi-speedometer2"
                                            style="color:#00d4ff"></i> 160cc</div>
                                    <div class="spec-item"><i class="bi bi-gear-fill" style="color:#00d4ff"></i>
                                        Matic</div>
                                    <div class="spec-item"><i class="bi bi-droplet-fill"
                                            style="color:#00d4ff"></i> Bensin</div>
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 150.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
                ...
                <!-- Beat -->
                <div class="col-xl-3 col-lg-4 col-md-6 fade-up vehicle-item" data-type="motor" data-cat="Matic"
                    data-name="honda beat" data-price="90000" style="transition-delay:0.30s">
                    <a href="{{ route('detail') }}" class="card-link">
                        <div class="car-card motor-card">
                            <div class="car-img-wrap">
                                <span class="car-badge">HEMAT</span>
                                ...
                                <svg viewBox="0 0 280 120" xmlns="http://www.w3.org/2000/svg"
                                    style="width:100%;max-width:220px;position:relative;z-index:1;">
                                    <defs>
                                        <linearGradient id="mg5" x1="0%" y1="0%"
                                            x2="100%" y2="100%">
                                            <stop offset="0%" style="stop-color:#252525" />
                                            <stop offset="100%" style="stop-color:#151515" />
                                        </linearGradient>
                                    ...
                                    <ellipse cx="140" cy="112" rx="105" ry="6"
                                        fill="rgba(0,0,0,0.4)" />
                                    <circle cx="80" cy="100" r="24" fill="#111" stroke="#2a2a2a"
                                        stroke-width="2" />
                                    <circle cx="80" cy="100" r="16" fill="#0a0a0a" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="80" cy="100" r="5" fill="#1a1a1a"
                                        stroke="rgba(0,212,255,0.4)" stroke-width="1.2" />
                                    <circle cx="205" cy="100" r="22" fill="#111" stroke="#2a2a2a"
                                        stroke-width="2" />
                                    <circle cx="205" cy="100" r="14" fill="#0a0a0a" stroke="#333"
                                        stroke-width="1.5" />
                                    <circle cx="205" cy="100" r="5" fill="#1a1a1a"
                                        stroke="rgba(0,212,255,0.4)" stroke-width="1.2" />
                                    <path d="M80 98 L105 65 L160 60 L195 75 L205 88" fill="none" stroke="#2a2a2a"
                                        stroke-width="3" stroke-linecap="round" />
                                    <path d="M105 65 L160 60 L190 72 L170 82 L118 84 Z" fill="url(#mg5)"
                                        stroke="#333" stroke-width="1" />
                                    <ellipse cx="207" cy="72" rx="9" ry="6"
                                        fill="rgba(0,212,255,0.8)" opacity="0.7" />
                                </svg>
                            </div>
                            <div class="car-body">
                                ...
                                <div class="car-specs">
                                    <div class="spec-item"><i class="bi bi-speedometer2"
                                            style="color:#00d4ff"></i> 110cc</div>
                                    <div class="spec-item"><i class="bi bi-gear-fill" style="color:#00d4ff"></i>
                                        Matic</div>
                                    <div class="spec-item"><i class="bi bi-droplet-fill"
                                            style="color:#00d4ff"></i> Bensin</div>
                                ...
                                <div class="car-footer">
                                    <div class="car-price"><span class="price-amount">Rp 90.000</span><span
                                            class="price-label">per hari</span></div>
                                    <div class="btn-rent">DETAIL <i class="bi bi-arrow-right"></i></div>
                                </div>
                            </div>
