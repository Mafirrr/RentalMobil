    ...
    <div class="container-fluid">
        ...
        <div class="card bg-secondary bg-opacity-10 border-0 shadow-sm mb-5" style="border-radius: 20px;">
            <div class="card-body p-3">
                <div class="row align-items-center g-3">
                    <div class="col-lg-8">
                        <form action="{{ route('admin.cars') }}" method="GET">
                            <div
                    ...
                    <div class="col-lg-4 d-flex justify-content-lg-end gap-2">
                        ...
                        <a href="{{ route('admin.cars', ['status' => 'available']) }}"
        ...
        <div class="row g-4">
            <div class="col-xl-3 col-md-6">
                <a href="{{ route('admin.cars.create') }}" class="text-decoration-none h-100">
                    <div class="card h-100 bg-transparent border-secondary border-opacity-25 d-flex align-items-center justify-content-center py-5"
                        ...
                        <div class="text-center text-secondary">
                            ...
                            <h5 class="fw-bold text-white">Tambah Mobil</h5>
                        </div>
                    </div>
                </a>
            </div>
            ...
            @foreach ($cars as $car)
                    ...
                    <div class="card h-100 bg-secondary bg-opacity-10 border-0 shadow-sm"
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div>
                                    <h4 class="fw-bold mb-0 text-white">{{ $car->model }}</h4>
                                    <p class="text-secondary small mb-0">{{ $car->plate_number }}</p>
                                </div>
                                <button type="button" class="btn btn-outline-info btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#detailModal{{ $car->id }}">
                            ...
                            <div class="d-flex gap-2 mb-4">
                                <span
                                    class="badge bg-dark text-secondary border border-secondary border-opacity-25 fw-normal">{{ $car->transmission == 'Manual' ? 'Manual' : 'Automatic' }}</span>
                                <span
                                    class="badge bg-dark text-secondary border border-secondary border-opacity-25 fw-normal">{{ $car->year }}</span>
                                <span
                ...
                <div class="modal fade" id="detailModal{{ $car->id }}" tabindex="-1" aria-hidden="true">
